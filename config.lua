...
Config.DamagePedOnCrash = false -- applies 20 damage to ped on car crash  
Config.PedCrashDamage = 20 


Config.randomTireBurstInterval = 100			-- Number of minutes (statistically, not precisely) to drive above 22 mph before you get a tire puncture. 0=feature is disabled
